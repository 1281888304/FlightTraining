      ...
      body: ListView(
        children: <Widget>[
          ...
          DataTable(columns: [
            ...
            DataRow(cells: [
              DataCell(Text(
                  'Solo cross-country flight: § 61.93(c)(1) and 61.93(c)(2) - ')),
              DataCell(
                Icon(Icons.check_circle, size: 20.5, color: Colors.green),
              ),
            ...
            DataRow(cells: [
              ...
              DataCell(
                Icon(Icons.adjust, size: 20.5, color: Colors.red),
              ),
              DataCell(Text('N/A')),
            ]),
          ])
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  ExpansionTile(
                    ...
                    //   )
                    // ],
                    children: <Widget>[Text('Lesson')],
                  ),
                  ExpansionTile(
                    title: Text('Data'),
                    children: <Widget>[Text('15/11/2020')],
                  ),
                  ExpansionTile(
                    title: Text('Instructor'),
                    children: <Widget>[Text('Amy')],
                  ),
                  ExpansionTile(
                    title: Text('Total Flight time'),
                    children: <Widget>[Text('2 hours')],
                  ),
                  ExpansionTile(
                    title: Text('Tasks'),
                    children: <Widget>[Text('1/5')],
                  ),
                  ExpansionTile(
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  ...
                  ExpansionTile(
                    ...
                    children: <Widget>[
                      ExpansionTile(
                        title: Text('Stage I: Pre-SOLO AND SOLO'),
                        children: <Widget>[
                          ExpansionTile(
                            title: Text('Preflight Preparation'),
                            children: <Widget>[Text('50')],
                          ),
                          ExpansionTile(
                            title: Text('Basic and Performance Maneuvers'),
                            children: <Widget>[Text('null')],
                          ),
                          ExpansionTile(
                            title: Text('Preflight Procedures'),
                            children: <Widget>[Text('null')],
                          )
                        ],
                      ),
                  ...
                  ExpansionTile(
                    ...
                    children: <Widget>[
                      ...
                      InkWell(
                        ...
                        onTap: () => launch(
                            'https://www.faa.gov/regulations_policies/handbooks_manuals/aviation/airplane_handbook/media/05_afh_ch3.pdf'),
                      )
                    ],
                  ),
                  ExpansionTile(
